	...
	function simpan_pengguna(){
        ...
        if(!empty($_FILES['filefoto']['name']))
        {
            if ($this->upload->do_upload('filefoto'))
            {
					...
					$npak=htmlspecialchars($this->input->post('xnpak'),ENT_QUOTES);
					...
					if ($password <> $konfirm_password) {
						...
						$this->m_pengguna->simpan_pengguna($npak,$nama,$jenkel,$username,$password,$gambar,$level);
			...
			if ($password <> $konfirm_password) {
           		...
           		$this->m_pengguna->simpan_pengguna_tanpa_gambar($npak,$nama,$jenkel,$username,$password,$level);
                echo $this->session->set_flashdata('msg','success');
           		redirect('admin/pengguna');
           	}
        }
        ...
        if(!empty($_FILES['filefoto']['name']))
        {
            if ($this->upload->do_upload('filefoto'))
            {
                    ...
                    if (empty($password) && empty($konfirm_password)) {
                    	$this->m_pengguna->update_pengguna_tanpa_pass($kode,$nama,$jenkel,$username,$password,$gambar,$level);
                		echo $this->session->set_flashdata('msg','info');
           				...
           				$this->m_pengguna->update_pengguna($kode,$nama,$jenkel,$username,$password,$gambar,$level);
                		echo $this->session->set_flashdata('msg','info');
           				redirect('admin/pengguna');
           			}
        	...
        	if (empty($password) && empty($konfirm_password)) {
               	$this->m_pengguna->update_pengguna_tanpa_pass_dan_gambar($kode,$nama,$jenkel,$username,$password,$level);
                echo $this->session->set_flashdata('msg','info');
           		redirect('admin/pengguna');
				}elseif ($password <> $konfirm_password) {
					echo $this->session->set_flashdata('msg','error');
           		...
           		$this->m_pengguna->update_pengguna_tanpa_gambar($kode,$nama,$jenkel,$username,$password,$level);
                echo $this->session->set_flashdata('msg','success');
           		redirect('admin/pengguna');
           	}
        } 
